...
const Footer = () => {
  ...
  const legalLinks = [
    { title: "Política de Privacidade", path: "/politica-privacidade" },
    { title: "Termos e Condições", path: "/termos-condicoes" },
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="md:col-span-2 text-center md:text-left">
            <Link to="/" className="inline-block font-poppins font-bold text-2xl mb-4 text-foreground">
              Gêniozinho
            </Link>
          ...
          <div className="text-center md:text-left">
            <h3 className="font-poppins font-semibold text-lg mb-4 text-foreground">Jogos</h3>
            <ul className="space-y-3">
              {jogosLinks.map((link) => (
                <li key={link.path}>
                  <Link
                    to={link.path}
                    className="text-muted-foreground text-sm hover:text-primary transition-colors duration-200 font-inter"
                  >
                    {link.title}
                  </Link>
                </li>
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex flex-col items-center md:items-start">
            <span className="text-sm font-semibold text-foreground mb-2">Com o apoio de Guia do Player:</span>
            <div className="flex items-center space-x-4">
              <a
                ...
                className="w-10 h-10 bg-background rounded-full flex items-center justify-center hover:bg-primary hover:text-primary-foreground text-muted-foreground shadow-sm transition-all duration-200 hover:scale-105"
              >
