                  ...
                  () async {
                    if (rate >= 3) {
                      ...
                      final Email email = Email(
                        body: feedback,
                        subject: 'Comentários do aplicativo',
                        isHTML: false,
                      );
    ...
    return Expanded(
      child: ListView(
        ...
        children: [
          ...
          getCustomFont("Dê feedback", 53, fontColor, 1,
              fontWeight: FontWeight.w900),
          getVerSpace(FetchPixels.getPixelHeight(25)),
          getCustomFont("Dê sua opinião sobre nosso aplicativo", 35, fontColor, 1,
              fontWeight: FontWeight.w500),
          getVerSpace(FetchPixels.getPixelHeight(100)),
          getCustomFont("Você está satisfeito com este aplicativo?", 35, fontColor, 1,
          ...
          getCustomFont("Diga-nos o que pode ser melhorado!", 35, fontColor, 1,
              fontWeight: FontWeight.w800),
          getVerSpace(FetchPixels.getPixelHeight(40)),
          getDefaultTextFiled(context, "Escreva seu feedback...",
