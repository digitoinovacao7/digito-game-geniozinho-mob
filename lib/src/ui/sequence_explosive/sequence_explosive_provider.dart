...
import '../../data/models/sequence_explosive.dart';

class SequenceExplosiveProvider extends GameProvider<SequenceExplosive> {
  BuildContext? context;
  int? level;
  int? selectedAnswerIndex;

  SequenceExplosiveProvider({
    required TickerProvider vsync,
    required int level,
    required BuildContext context,
  }) : super(vsync: vsync, gameCategoryType: GameCategoryType.SEQUENCE_EXPLOSIVE, c: context) {
    this.level = level;
