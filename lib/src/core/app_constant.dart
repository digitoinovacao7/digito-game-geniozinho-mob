...
class KeyUtil {
  ...
  static List<Dashboard> dashboardItems = [
    ...
    Dashboard(
        ...
        gridColor: bgColor2,
        subtitle:
            "Memorize números e sinais antes de aplicar cálculos a eles.",
    ...
    Dashboard(
        ...
        subtitle:
            "Melhore o pensamento lógico, a concentração e as principais habilidades cognitivas.",
        title: "Treine seu cérebro",
